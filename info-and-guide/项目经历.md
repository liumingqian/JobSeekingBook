...
px4可以直接运行在真机上，因此没有传感器信息和环境信息，需要viwo（airlib进行模拟\)
...
* 无法断点调试，模拟效果跟更新频率有关，涉及网络和多线程。（物理引擎一个线程，渲染一个线程，收发mavlink消息一个线程，px4也有多个线程）
* 资料少，从Airsim切入，但Airsim文档有些过期，为了可扩展性封装实在太多层了。
...
绩效考核，加班，年假，年终奖，晋升和调薪，五险一金怎么交，工作岗位和部门情况
